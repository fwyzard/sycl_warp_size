...
test: main.cc kernel.h sycl_subgroup_size.h printf.h
...
test.jit: main.cc kernel.h sycl_subgroup_size.h printf.h
	icpx -std=c++17 -O2 -g -Wno-unknown-cuda-version -fsycl -fsycl-device-code-split=per_kernel -fsycl-targets=spir64 $< -o $@

test.aot: main.cc kernel.h sycl_subgroup_size.h printf.h
